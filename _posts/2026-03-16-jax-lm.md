...
>The associated code can be found at [https://github.com/chuyishang/jax-lm/](https://github.com/chuyishang/jax-lm/) and, if you want to try coding it yourself, you can use the [`assignment`](https://github.com/chuyishang/jax-lm/tree/assignment) branch of the repo as a starter.
