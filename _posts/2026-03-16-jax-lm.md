...
This blog post also references the [How to Scale Your Model](https://jax-ml.github.io/scaling-book/)<d-cite>Austin et al., "How to Scale Your Model", Google DeepMind, online, 2025.</d-cite>book, which describes distributed training and sharding with JAX in much more detail. We recommend reading that book in parallel with this blog post to gain a deeper understanding of distributed training.
