  ...
  <table class="table table-sm table-bordered">
    ...
    <tbody>
      <tr>
        ...
        <td><code>batch</code></td>
        <td><code>("data", None)</code></td>
        <td>$\left[ \frac{B}{X}, \frac{D}{Y} \right]$</td>
      </tr>
      <tr>
        <td>$W_{Q}, W_{K}, W_{V}$</td>
        <td>$[D, N*H]$</td>
...
We also provide a PyTorch implementation of these distributed training methods (DP, TP, FSDP, FSDP+TP) for comparison. You can find it [here](https://github.com/chuyishang/jax-lm/tree/main/pytorch_impl/distributed). Note how much more complex it is!
